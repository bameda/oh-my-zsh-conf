...
plugins=(archlinux git git-extras git-remote-branch github history history-substring-search supervisor systemd python django virtualenvwrapper zsh-syntax-highlighting)
